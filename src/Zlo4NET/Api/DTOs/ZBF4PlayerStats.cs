...
namespace Zlo4NET.Api.DTOs
{
    ...
    public class ZBF4PlayerStats : ZPlayerStatsBase
    {
        ...
        public double CommanderCurrentLongScore { get; set; }
        [ZStatsMapper(MapFromDictionaryKey = "ssclco_00", TargetType = typeof(int))]
        public int CommanderStartCount { get; set; }
        ...
        public float CommanderCurrentRelativeScore { get; set; }
        ...
        public float AssaultMaxRelativeScore { get; } = 155000f;
        public float EngineerMaxRelativeScore { get; } = 131000f;
        public float ReconMaxRelativeScore { get; } = 134000f;
        public float SupportMaxRelativeScore { get; } = 104000f;
        public float CommanderMaxRelativeScore { get; } = 20000f;
