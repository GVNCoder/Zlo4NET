...
{
    internal class ZBF4ServerListParser : ZServerListParserBase
    {
        #region Ctor

        public ZBF4ServerListParser(uint currentUserId) : base(currentUserId, ZGame.BF4)
        {
        }
